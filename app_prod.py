...
Database users
/api/users
/api/users/<int:userid>
Get token here:
/api/token

To get token:
curl -u <username>:<password>  -X GET  <address>:5000/api/token

To call API using token:
curl -u <token>:unused -i -X GET  -H "Content-Type: application/json" <address>:5000/api/users
